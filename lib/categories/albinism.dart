...
class Albinism extends StatefulWidget {
  @override
  _AlbinismState createState() => _AlbinismState();
}

class _AlbinismState extends State<Albinism> {
  @override
          ...
          Center(
            child: Padding(
              ...
              child: Text(
                ...
                style: GoogleFonts.comfortaa(fontSize: 17, color: Colors.black),
